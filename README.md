...
<a name="courses"></a>
## Курсы лекций (и книги) [^](#top "к оглавлению")
...
<a name="parts"></a>
## По темам (+ краткий конспект) [^](#top "к оглавлению")

<a name="internals"></a>
### Внутренности питона [^](#top "к оглавлению")
...
<a name="datatypes"></a>
### Типы данных. Коллекции [^](#top "к оглавлению")
...
### Циклы, условия, операторы [^](#top "к оглавлению")
...
### Итераторы и генераторы. Сопрограммы [^](#top "к оглавлению")
...
### Функции. Замыкания. Декораторы [^](#top "к оглавлению")
...
### ООП. Магические методы. Протокол дескрипторов. Метаклассы. Статические методы и методы класса [^](#top "к оглавлению")
...
### Возможности стандартной библиотеки [^](#top "к оглавлению")
...
### Обработка исключений. Контекстные менеджеры [^](#top "к оглавлению")
...
### Пакеты и модули. Pypi. pip и easy_install. virtualenv [^](#top "к оглавлению")
...
### Многопоточность. GIL. Многопроцессные приложения [^](#top "к оглавлению")
...
### Асинхронное программирование. Event loop. Теория [^](#top "к оглавлению")
...
### Асинхронные фреймворки и библиотеки [^](#top "к оглавлению")
...
### Работа с памятью [^](#top "к оглавлению")
...
### Вопросы производительности [^](#top "к оглавлению")
...
### Утилиты для улучшения качества кода [^](#top "к оглавлению")
...
### Работа с СУБД. Драйверы. Популярные ORM [^](#top "к оглавлению")
...
### Библиотеки NumPy и Pandas [^](#top "к оглавлению")
...
## Полезное [^](#top "к оглавлению")

### Must-read книги [^](#top "к оглавлению")
...
### Telegram-каналы [^](#top "к оглавлению")
